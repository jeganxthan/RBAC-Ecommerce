...
const SideMenu = ({ activeMenu }) => {
  ...
  <div>
    {!open && (
      <div className="fixed top-0 left-0 h-full w-16 bg-white shadow-md z-30 flex flex-col items-center py-4">
            ...
            {menuItems.map((item) => {
              ...
              return (
                <li
                  ...
                  ${isActive ? 'text-[#1977a8] font-semibold' : 'text-black hover:bg-gray-100'}`}
                  onClick={() => handleItemClick(item.path)}
                >
